...
MODULES                 = DAHostLib_rtw.c hostlib_vntcan.c TruckBenchmark.c TruckBenchmark_capi.c TruckBenchmark_data.c TruckBenchmark_tgtconn.c can_datatype_ground.c rtGetInf.c rtGetNaN.c rt_look.c rt_look1d.c rt_nonfinite.c raccel_main.c raccel_sup.c raccel_mat.c simulink_solver_api.c raccel_utils.c common_utils.c ext_svr.c updown.c ext_work.c rtiostream_interface.c rtiostream_tcpip.c rtiostream_utils.c
PRODUCT                 = TruckBenchmark.exe
...
S_FUNCTIONS_LIB         = $(MATLAB_ROOT)\extern\lib\win64\microsoft\tammex.lib $(MATLAB_ROOT)\lib\win64\j1939.lib
NUMST                   = 6
NCSTATES                = 13
...
{$(MATLAB_ROOT)\toolbox\vnt\vntblks\include}.c.obj :
	@cmd /C "echo ### Compiling $<"
	$(CC) $(CFLAGS) $<

{$(MATLAB_ROOT)\toolbox\shared\can\src\scanutil}.c.obj :
	@cmd /C "echo ### Compiling $<"
	$(CC) $(CFLAGS) $<

{$(MATLAB_ROOT)\toolbox\shared\testmeas\src\tammex}.c.obj :
	@cmd /C "echo ### Compiling $<"
	$(CC) $(CFLAGS) $<
...
DAHostLib_rtw.obj : $(MATLAB_ROOT)\toolbox\shared\spc\src_ml\extern\src\DAHostLib_rtw.c
	@cmd /C "echo ### Compiling $(MATLAB_ROOT)\toolbox\shared\spc\src_ml\extern\src\DAHostLib_rtw.c
	$(CC) $(CFLAGS) $(MATLAB_ROOT)\toolbox\shared\spc\src_ml\extern\src\DAHostLib_rtw.c

hostlib_vntcan.obj : $(MATLAB_ROOT)\toolbox\vnt\vntblks\include\hostlib_vntcan.c
	@cmd /C "echo ### Compiling $(MATLAB_ROOT)\toolbox\vnt\vntblks\include\hostlib_vntcan.c
	$(CC) $(CFLAGS) $(MATLAB_ROOT)\toolbox\vnt\vntblks\include\hostlib_vntcan.c
...
{$(MATLAB_ROOT)\toolbox\vnt\vntblks\include}.cpp.obj :
	@cmd /C "echo ### Compiling $<"
	$(CC) $(CPPFLAGS) $<

{$(MATLAB_ROOT)\toolbox\shared\can\src\scanutil}.cpp.obj :
	@cmd /C "echo ### Compiling $<"
	$(CC) $(CPPFLAGS) $<

{$(MATLAB_ROOT)\toolbox\shared\testmeas\src\tammex}.cpp.obj :
	@cmd /C "echo ### Compiling $<"
	$(CC) $(CPPFLAGS) $<
