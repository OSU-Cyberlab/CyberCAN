...
MODEL                   = TruckBenchmark
MODULES                 = TruckBenchmark_acc.c TruckBenchmark_acc_data.c rtGetInf.c rtGetNaN.c rt_look.c rt_look1d.c rt_nonfinite.c c_mexapi_version.c
PRODUCT                 = $(RELATIVE_PATH_TO_ANCHOR)\TruckBenchmark_acc.mexw64
MAKEFILE                = TruckBenchmark.mk
MATLAB_ROOT             = C:\Program Files\MATLAB\R2023a
ALT_MATLAB_ROOT         = C:\PROGRA~1\MATLAB\R2023a
START_DIR               = C:\Users\qazim\ONEDRI~1\APPLIC~1\PROJEC~1\SDCS\GENERA~1\TRUCKS~1\TRUCKB~1.2\TRUCKB~1
S_FUNCTIONS_LIB         = $(MATLAB_ROOT)\lib\win64\j1939.lib
NUMST                   = 6
NCSTATES                = 13
...
ADDITIONAL_LDFLAGS      =  /IMPLIB:TruckBenchmark_acc.lib /EXPORT:mexFunction /EXPORT:mexfilerequiredapiversion
...
MODELLIB                  = TruckBenchmark_acc.mexw64
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = TruckBenchmark_ref.rsp
COMPILER_COMMAND_FILE     = TruckBenchmark_comp.rsp
...
TruckBenchmark_acc.obj : $(START_DIR)\slprj\accel\TruckBenchmark\TruckBenchmark_acc.c
	@cmd /C "echo ### Compiling $(START_DIR)\slprj\accel\TruckBenchmark\TruckBenchmark_acc.c
	$(CC) $(CFLAGS) $(START_DIR)\slprj\accel\TruckBenchmark\TruckBenchmark_acc.c

TruckBenchmark_acc_data.obj : $(START_DIR)\slprj\accel\TruckBenchmark\TruckBenchmark_acc_data.c
	@cmd /C "echo ### Compiling $(START_DIR)\slprj\accel\TruckBenchmark\TruckBenchmark_acc_data.c
	$(CC) $(CFLAGS) $(START_DIR)\slprj\accel\TruckBenchmark\TruckBenchmark_acc_data.c

rtGetInf.obj : $(START_DIR)\slprj\accel\TruckBenchmark\rtGetInf.c
	@cmd /C "echo ### Compiling $(START_DIR)\slprj\accel\TruckBenchmark\rtGetInf.c
	$(CC) $(CFLAGS) $(START_DIR)\slprj\accel\TruckBenchmark\rtGetInf.c

rtGetNaN.obj : $(START_DIR)\slprj\accel\TruckBenchmark\rtGetNaN.c
	@cmd /C "echo ### Compiling $(START_DIR)\slprj\accel\TruckBenchmark\rtGetNaN.c
	$(CC) $(CFLAGS) $(START_DIR)\slprj\accel\TruckBenchmark\rtGetNaN.c

rt_look.obj : $(START_DIR)\slprj\accel\TruckBenchmark\rt_look.c
	@cmd /C "echo ### Compiling $(START_DIR)\slprj\accel\TruckBenchmark\rt_look.c
	$(CC) $(CFLAGS) $(START_DIR)\slprj\accel\TruckBenchmark\rt_look.c

rt_look1d.obj : $(START_DIR)\slprj\accel\TruckBenchmark\rt_look1d.c
	@cmd /C "echo ### Compiling $(START_DIR)\slprj\accel\TruckBenchmark\rt_look1d.c
	$(CC) $(CFLAGS) $(START_DIR)\slprj\accel\TruckBenchmark\rt_look1d.c

rt_nonfinite.obj : $(START_DIR)\slprj\accel\TruckBenchmark\rt_nonfinite.c
	@cmd /C "echo ### Compiling $(START_DIR)\slprj\accel\TruckBenchmark\rt_nonfinite.c
	$(CC) $(CFLAGS) $(START_DIR)\slprj\accel\TruckBenchmark\rt_nonfinite.c
