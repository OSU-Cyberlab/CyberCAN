#ifndef RTW_HEADER_TruckBenchmark_acc_private_h_
#define RTW_HEADER_TruckBenchmark_acc_private_h_
#include "rtwtypes.h"
...
int_T * maxNewBufSzPtr ) ; real_T look_SplNBinXScd ( uint32_T numDims , const
real_T * u , const rt_LUTSplineWork * const SWork ) ; void rt_Spline2Derivd (
const real_T * x , const real_T * y , uint32_T n , real_T * u , real_T * y2 )
; real_T intrp_NSplcd ( uint32_T numDims , const rt_LUTSplineWork * const
splWork , uint32_T extrapMethod ) ; real_T
TruckBenchmark_acc_rt_TDelayInterpolate ( real_T tMinusDelay , real_T tStart
